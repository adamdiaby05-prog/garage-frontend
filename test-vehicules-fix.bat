@echo off
echo ========================================
echo    TEST - CORRECTION DES VÉHICULES
echo ========================================
echo.
...
echo    1. Vérifiez que la liste des véhicules s'affiche
echo    2. Créez un nouveau véhicule avec tous les champs
echo    3. Vérifiez que la création fonctionne sans erreur 500
